  ...
  return (
    <Box>
      <List sx={{ color: 'text.primary' }}>
        <ListSubheader>
          Binary Artisan (Contract) | Software Engineer | Count Your Cards 2024
          – 2024
        </ListSubheader>
        <ListItem>
        ...
        <ListItem>
          Engineered the GKE Kubernetes cluster data scraping of cluster data
          from node exporter and metric server allowing the application to
          receive data for storage and live data monitoring of the cluster’s
          health for both nodes and pods
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          ...
          flexible schema, and horizontal scaling used for in-session
          performance reporting, historical reporting, as well as providing a
          solution for readily accessible information across systems
        </ListItem>
        <ListItem>
          Leveraged D3's high customization, data-driven approach, and web
          standards compliance to create interactive, color-coded
          visualizations, simplifying cluster health assessment of nodes and
          pods by CPU and memory usage for end-users
        </ListItem>
        <ListItem>
          Utilized Express.js for its flexibility in an application’s structure,
